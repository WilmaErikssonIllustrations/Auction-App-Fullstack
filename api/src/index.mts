...
app.use(
  cors({
    origin: ["http://localhost:5173", "https://auction-app-fullstack.netlify.app", /https:\/\/.*--auction-app-fullstack\.netlify\.app/], 
    credentials: true,
  }),
);
app.use(json());
...
export const io = new Server(server, {
  cors: {
    origin: ["http://localhost:5173", "https://auction-app-fullstack.netlify.app", /https:\/\/.*--auction-app-fullstack\.netlify\.app/], // <-- BYT UT till din riktiga Netlify-länk här
    methods: ["GET", "POST"],
    credentials: true,
  },
});
